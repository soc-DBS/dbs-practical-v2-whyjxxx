/*
  ...
  - You are about to drop the `_StudentCrseCode` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_StudentNationality` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "_StudentCrseCode" DROP CONSTRAINT "_StudentCrseCode_A_fkey";

-- DropForeignKey
ALTER TABLE "_StudentCrseCode" DROP CONSTRAINT "_StudentCrseCode_B_fkey";

-- DropForeignKey
ALTER TABLE "_StudentNationality" DROP CONSTRAINT "_StudentNationality_A_fkey";

-- DropForeignKey
ALTER TABLE "_StudentNationality" DROP CONSTRAINT "_StudentNationality_B_fkey";
...
-- DropForeignKey
ALTER TABLE "stud_mod_performance" DROP CONSTRAINT "module_mod_reg_fk";

-- DropForeignKey
ALTER TABLE "stud_mod_performance" DROP CONSTRAINT "student_adm_no_fk";

-- DropTable
DROP TABLE "_StudentCrseCode";

-- DropTable
DROP TABLE "_StudentNationality";
